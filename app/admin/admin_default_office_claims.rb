ActiveAdmin.register DefaultOfficeClaim, as: 'Default Office Claims' do
  ...
  remove_filter :exports, :commands, :events, :pdf_template_reference, :email_template_reference, :ccd_export
  remove_filter :confirmation_email_recipients, :time_zone, :office, :case_type, :manually_actioned
